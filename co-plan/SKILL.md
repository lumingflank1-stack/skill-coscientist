...
5. **EN:** For virtual results, write a prompt that clearly requests simulated output and defines positive, negative, ambiguous, or mixed mode.  
   **中：** 对虚拟结果，写清楚“模拟输出”请求，并定义阳性、阴性、模糊或混合结果模式。
